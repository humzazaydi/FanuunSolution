...
{
    public abstract class FanuunSolutionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FanuunSolutionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FanuunSolutionWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<FanuunSolutionDbContext> action)
        {
            using (var context = IocManager.Resolve<FanuunSolutionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<FanuunSolutionDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<FanuunSolutionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FanuunSolutionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FanuunSolutionDbContext, Task<T>> func)
        {
            T result;
