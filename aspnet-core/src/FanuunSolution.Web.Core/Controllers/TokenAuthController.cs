...
using Abp.UI;
using FanuunSolution.Authentication.External;
using FanuunSolution.Authentication.JwtBearer;
...
namespace FanuunSolution.Controllers
{
    ...
    public class TokenAuthController : FanuunSolutionControllerBase
    {
